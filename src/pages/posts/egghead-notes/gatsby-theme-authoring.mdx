...
export const meta = {
  ...
  url: 'https://parkerlandon.com/posts/egghead-notes/gatsby-theme-authoring',
...
1. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-set-up-yarn-workspaces-for-gatsby-theme-development">
     Set up Yarn Workspaces for Gatsby Theme Development
   </Link>

2. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-add-static-data-to-a-gatsby-theme">
     Add Static Data to a Gatsby Theme
   </Link>

3. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-create-a-data-directory-in-gatsby-using-the-onprebootstrap-lifecycle">
     Create a Data Directory in Gatsby using the onPreBootstrap lifecycle
   </Link>

4. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-set-up-to-create-data-driven-pages-in-gatsby">
     Set up to Create Data Driven Pages in Gatsby
   </Link>

5. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-create-data-driven-pages-in-gatsby-with-graphql-and-createpages">
     Create Data Driven Pages in Gatsby with GraphQL and createPages
   </Link>

6. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-display-sorted-data-with-usestaticquery-in-gatsby">
     Display Sorted Data with useStaticQuery in Gatsby
   </Link>

7. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-display-and-query-data-by-id-with-gatsby-context-and-usestaticquery">
     Display and Query Data by id with Gatsby context and useStaticQuery
   </Link>

8. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-style-and-format-dates-in-react">
     Style and Format Dates in React
   </Link>

9. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-configure-a-gatsby-theme-to-take-options">
     Configure a Gatsby Theme to Take Options
   </Link>

10. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-make-gatsby-themes-extendable-with-gatsby-theme-ui">
      Make Gatsby Themes extendable with gatsby-theme-ui
    </Link>

11. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-use-and-override-a-theme-in-gatsby-with-component-shadowing">
      Use and Override a Theme in Gatsby with Component Shadowing
    </Link>

12. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-publish-a-gatsby-theme-to-npm">
      Publish a Gatsby Theme to npm
    </Link>

13. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-consume-a-theme-in-a-gatsby-application">
      Consume a Theme in a Gatsby Application
    </Link>

14. <Link href="/posts/egghead-notes/gatsby-theme-authoring#-use-component-shadowing-to-override-gatsby-theme-components">
...
- “Component shadowing” is a mechanism to _override the default rendering_ provided by a Gatsby theme
...
inside <code>src/<npm_username>/<theme_name><br/>/components/layout.js</code>
