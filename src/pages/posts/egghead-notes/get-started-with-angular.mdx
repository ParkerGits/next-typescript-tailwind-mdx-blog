...
export const meta = {
  title: 'Get Started with Angular 🅰',
  titleText: 'Get Started with Angular',
  titleEmoji: '🅰',
  description:
    "Notes from John Lindquist's Get Started with Angular course on egghead.io.",
  url: 'https://parkerlandon.com/posts/egghead-notes/get-started-with-angular',
...
1. <Link href="/posts/egghead-notes/get-started-with-angular#-say-hello-world-to-angular-2">
     Say "Hello World" to Angular 2
   </Link>
2. <Link href="/posts/egghead-notes/get-started-with-angular#-create-a-simple-angular-2-component">
     Create a Simple Angular 2 Component
   </Link>
3. <Link href="/posts/egghead-notes/get-started-with-angular#-manage-angular-2-elements-with-events--refs">
     Manage Angular 2 Elements with Events & Refs
   </Link>
4. <Link href="/posts/egghead-notes/get-started-with-angular#-control-angular-2-events-with-event-and-event-handlers">
     Control Angular 2 Events with $event and Event Handlers
   </Link>
5. <Link href="/posts/egghead-notes/get-started-with-angular#-share-services-and-data-with-angular-2-dependency-injection">
     Share Services and Data with Angular 2 Dependency Injection
   </Link>
6. <Link href="/posts/egghead-notes/get-started-with-angular#-provide-and-share-values-with-angular-2-dependency-injection">
     Provide and Share Values with Angular 2 Dependency Injection
   </Link>
7. <Link href="/posts/egghead-notes/get-started-with-angular#-loop-through-angular-2-components-w-ngfor">
     Loop Through Angular 2 Components with ngFor
   </Link>
8. <Link href="/posts/egghead-notes/get-started-with-angular#-pass-values-into-angular-2-components-with-input">
     Pass Values into Angular 2 Components with @Input
   </Link>
9. <Link href="/posts/egghead-notes/get-started-with-angular#-sync-values-from-inputs-with-angular-2s-ngmodel-two-way-binding">
     Sync Values from Inputs with Angular 2’s ngModel Two-Way Binding
   </Link>
10. <Link href="/posts/egghead-notes/get-started-with-angular#-pass-events-from-angular-2-components-with-output">
      Pass Events from Angular 2 Components with @Output
    </Link>
11. <Link href="/posts/egghead-notes/get-started-with-angular#-write-css-inside-of-angular-2-components">
      Write CSS Inside of Angular 2 Components
    </Link>
12. <Link href="/posts/egghead-notes/get-started-with-angular#-apply-css-classes-conditionally-with-angular-2s-ngclass">
      Apply CSS Classes Conditionally with Angular 2’s ngClass
    </Link>
13. <Link href="/posts/egghead-notes/get-started-with-angular#-use-global-css-inside-angular-2-components">
