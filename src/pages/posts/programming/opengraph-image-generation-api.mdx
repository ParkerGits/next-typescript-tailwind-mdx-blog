...
1. <Link href="/posts/programming/opengraph-image-generation-api#-designing-opengraph-unfurls-in-figma">
     Designing OpenGraph unfurls in Figma
   </Link>

2. <Link href="/posts/programming/opengraph-image-generation-api#-building-an-opengraph-image-react-component-in-codesandbox-based-on-a-figma-design">
     Building an OpenGraph image React component in CodeSandbox, based on a
     Figma design
   </Link>

3. <Link href="/posts/programming/opengraph-image-generation-api#-setting-up-a-new-github-repo-to-deploy-functions-on-netlify-with-make-and-netlifytoml">
     Setting up a new GitHub repo to deploy functions on Netlify with Make and
     netlify.toml
   </Link>

4. <Link href="/posts/programming/opengraph-image-generation-api#-scaffolding-and-deploying-a-netlify-function-in-javascript">
     Scaffolding and deploying a Netlify function in Javascript
   </Link>

5. <Link href="/posts/programming/opengraph-image-generation-api#-using-playwright-to-screenshot-the-dom-and-return-an-image-from-a-netlify-function">
     Using Playwright to screenshot the DOM and return an image from a Netlify
     Function
   </Link>

6. <Link href="/posts/programming/opengraph-image-generation-api#-compiling-a-react-to-an-iife-with-rollup-to-execute-and-render-in-a-headless-browser">
     Compiling a React to an IIFE with Rollup to execute and render in a
     headless browser
   </Link>

7. <Link href="/posts/programming/opengraph-image-generation-api#-setting-the-viewport-on-a-playwright-headless-browser">
     Setting the viewport on a Playwright headless browser
   </Link>

8. <Link href="/posts/programming/opengraph-image-generation-api#-testing-an-opengraph-image-with-the-twitter-card-validator">
     Testing an opengraph image with the Twitter Card Validator
   </Link>

9. <Link href="/posts/programming/opengraph-image-generation-api#🦾-passing-variables-to-serverless-functions-using-query-strings">
     Passing variables to serverless functions using query strings
   </Link>

10. <Link href="/posts/programming/opengraph-image-generation-api#-using-cloudinary-as-a-write-through-cache-for-a-netlify-function-that-generates-images">
      Using Cloudinary as a write-through cache for a Netlify Function that
      generates images
    </Link>

11. <Link href="/posts/programming/opengraph-image-generation-api#-using-_redirects-files-on-netlify-to-make-netlify-function-urls-more-user-friendly">
