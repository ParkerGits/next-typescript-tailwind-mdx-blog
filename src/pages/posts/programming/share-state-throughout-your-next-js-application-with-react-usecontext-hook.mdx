---
title: Share State Throughout Your Next.js Application with React's useContext Hook 🤝
topic: programming
routename: share-state-throughout-your-next-js-application-with-react-usecontext-hook
description: How React's useContext hook helped me share form submissions and user data between separate pages in my Next.js project.
postnum: 8
---
...
export const meta = {
    title:
        "Share State Throughout Your Next.js Application with React's useContext Hook 🤝",
    description:
        "How React's useContext hook helped me share form submissions and user data between separate pages in my Next.js project.",
    url:
        'https://parkerlandon.com/posts/programming/share-state-throughout-your-next-js-application-with-react-usecontext-hook',
